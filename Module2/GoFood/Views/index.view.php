        ...
        <div id="card" class="card col-lg-4 mx-auto mt-4 ">
            <div id="newfood" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner text-center">
                    ...
                    <?php for ($i = 0; $i < count($foods); $i++) : ?>
                        <div class="carousel-item <?= $i == 0 ? 'active' : '' ?>">
                            <h3 id="datatb" class="card-header"><?= $foods[$i]->name ?></h3>
                            <img id="imgcard" src="<?= $foods[$i]->avatar ?>" alt="Card image" class="rounded mx-auto d-block w-100">
                            <!--Cho thêm hiện thị thông tin-->
                            <div id="pricecard" class="carousel-caption">
                                <div class="card-body">
                ...
                <div class="carousel-inner text-center">
                    ...
                    <?php for ($i = 0; $i < count($foods); $i++) : ?>
                        <div class="carousel-item <?= $i == 0 ? 'active' : '' ?>">
                            ...
                            <div class="card-footer text-center">
                                <a href="#" class="btn btn-danger w-50">Mua ngay</a>
                                <a href="#" class="btn btn-secondary w-45">Mua sau</a>
                            </div>
                        </div>
                    <?php endfor ?>
                </div>
...
<div class="container">
    ...
    <?php for ($i = 0; $i < count($foods); $i++) : ?>
        ...
        <div class="card col-lg-3 mx-auto mt-4">
            <h3 class="card-header"><?= $foods[$i]->name ?></h3>
            <img src="<?= $foods[$i]->avatar ?>" alt="Card image" width="200" height="200" class="rounded mx-auto d-block">
            <div class="card-body">
                <p id="price" class="card-text btn btn-block btn-warning"><?= $foods[$i]->price ?></p>
            </div>
            <div class="card-footer">
                <a href="#" class="card-link btn btn-danger">Mua Mgay</a>
                <a href="#" class="card-link  btn btn-secondary">Mua sau</a>
            </div>
        </div>
        <?= $i % 4 === 3 || $i == count($foods) ? '</div><hr>' : '' ?>
    <?php endfor ?>
